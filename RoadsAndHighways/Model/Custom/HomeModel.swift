...
let listhome:HomeList = HomeList(home: [Home(name: "Chief Engineers Office", image: UIImage(named: "chiefengineer"), id:628),
                                        ...
                                        Home(name: "Mechanical Services", image: UIImage(named: "mechanical"),id: 11),
