...
extension ChatListViewController {
    ...
    func getPeopleListDataFromFirestore() {
        ...
        db.collection("chat_room").addSnapshotListener { (snap, error) in
            ...
            for i in snap!.documentChanges {
                ...
                if i.type == .added {
                    ...
                    let data = ChatListData(lastMessage: lastMessage, username: username, isGroupChat: isGroupChat, userId: userId, title: title)
